    ...
    <form action="{{ route('admin.wajib-retribusi.update', $wajibRetribusi) }}" method="POST">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
            <div>
                ...
                <input type="text" name="nama_usaha" value="{{ old('nama_usaha', $wajibRetribusi->nama_usaha) }}" placeholder="Isi jika objek berupa toko/tempat usaha" style="display: block; width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 6px;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
            <div>
                ...
                <input type="text" name="npwp" value="{{ old('npwp', $wajibRetribusi->npwp) }}" placeholder="Nomor Pokok Wajib Pajak (Opsional)" style="display: block; width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 6px;">
            ...
            <div>
                ...
                <input type="text" name="nib" value="{{ old('nib', $wajibRetribusi->nib) }}" placeholder="Nomor Induk Berusaha (Opsional)" style="display: block; width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 6px;">
